...
export namespace biscuit::concepts {
	...
	//-----------------------------------------------------------------------------------------------------------------------------
	// for biscuit, opencv
	template < typename tcoord > concept has_x		= requires (tcoord a) { {a.x} -> arithmetic; };
	template < typename tcoord > concept has_y		= requires (tcoord a) { {a.y} -> arithmetic; };
	template < typename tcoord > concept has_z		= requires (tcoord a) { {a.z} -> arithmetic; };
	template < typename tcoord > concept has_w		= requires (tcoord a) { {a.w} -> arithmetic; };
	...
	template < typename tcoord > concept has_width	= requires (tcoord a) { {a.width } -> arithmetic;	};
	template < typename tcoord > concept has_height	= requires (tcoord a) { {a.height} -> arithmetic;	};
	template < typename tcoord > concept has_depth	= requires (tcoord a) { {a.depth } -> arithmetic;	};
	...
	//-----------------------------------------------------------------------------------------------------------------------------
	// for QT
	template < typename tcoord > concept has_qx			= requires (tcoord a) { {a.x()} -> arithmetic; };
	template < typename tcoord > concept has_qy			= requires (tcoord a) { {a.y()} -> arithmetic; };
	template < typename tcoord > concept has_qz			= requires (tcoord a) { {a.z()} -> arithmetic; };
	template < typename tcoord > concept has_qw			= requires (tcoord a) { {a.w()} -> arithmetic; };
	...
	template < typename tcoord > concept has_qwidth		= requires (tcoord a) { {a.width() } -> arithmetic; };
	template < typename tcoord > concept has_qheight	= requires (tcoord a) { {a.height()} -> arithmetic; };
	template < typename tcoord > concept has_qdepth		= requires (tcoord a) { {a.depth() } -> arithmetic; };
