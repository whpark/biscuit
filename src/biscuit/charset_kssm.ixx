...
export namespace biscuit::charset {
	...
	constexpr charKSSM_t ComposeKSSM(eKSSM ini, eKSSM mid, eKSSM fin) {
		return std::to_underlying(eKSSM::maskChar) | std::to_underlying(ini) | std::to_underlying(mid) | std::to_underlying(fin);
	}

	eKSSM GetKSSM_Syllable(std::map<wchar_t, eKSSM> const& map, wchar_t c, eKSSM cDefault) {
	...
	eKSSM GetKSSM_Ini(wchar_t c) { return GetKSSM_Syllable(s_mapW2KSSM_Ini, c, eKSSM::Ini_Fill); }
	eKSSM GetKSSM_Mid(wchar_t c) { return GetKSSM_Syllable(s_mapW2KSSM_Mid, c, eKSSM::Mid_Fill); }
	eKSSM GetKSSM_Fin(wchar_t c) { return GetKSSM_Syllable(s_mapW2KSSM_Fin, c, eKSSM::Fin_Fill); }

	charKSSM_t ComposeKSSM(wchar_t i, wchar_t m, wchar_t f = L'\0') {
	...
	constexpr std::tuple<charKSSM_t, charKSSM_t, charKSSM_t> DeComposeKSSM(charKSSM_t c) {
