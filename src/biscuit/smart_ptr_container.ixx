...
export module biscuit.smart_ptr_container;
import std;
import biscuit.aliases;
import biscuit.concepts;
import biscuit.mutex;
...
export namespace biscuit {
	...
	//--------------------------------------------------------------------------------------------------------------------------------------------------------
	// TSmartPtrContainer
	template < typename T, template < typename T > typename TSmartPtr, template < typename TSmartPtr > typename base_container, typename TMutex = biscuit::null_mutex >
	...
	template < typename T >
	using TConcurrentUPtrVector = TSmartPtrContainer<T, std::unique_ptr, std::vector, shared_recursive_mutex>;
	template < typename T >
	using TConcurrentSPtrVector = TSmartPtrContainer<T, std::shared_ptr, std::vector, shared_recursive_mutex>;

	template < typename T >
	using TConcurrentUPtrDeque = TSmartPtrContainer<T, std::unique_ptr, std::deque, shared_recursive_mutex>;
	template < typename T >
	using TConcurrentSPtrDeque = TSmartPtrContainer<T, std::shared_ptr, std::deque, shared_recursive_mutex>;
