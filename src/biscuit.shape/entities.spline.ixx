...
export CEREAL_REGISTER_TYPE(biscuit::shape::xSpline);
export CEREAL_REGISTER_POLYMORPHIC_RELATION(biscuit::shape::xShape, biscuit::shape::xSpline);
export CEREAL_CLASS_VERSION(biscuit::shape::xSpline, biscuit::shape::xSpline::s_version);
